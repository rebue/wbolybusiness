        ...
        n = {
            ...
            close: function(a, b) {
                if (h) {
                    ...
                    if (c === !1) return;
                    b !== !1 ? (h.classList.remove(f), h.classList.add(g)) : i(),
                    p.pop(),
...
function(a, b, c) {
    ...
    h = function(b, c) {
        ...
        null === this.options.loadingIcon && (this.options.loadingIcon = "mui-spinner", "rgb(255, 255, 255)" === a.getStyles(this.element, "color") && (this.options.loadingIcon += " mui-spinner-white")),
    ...
    h.prototype.setState = function(a) {
        ...
        if (this.state = a, a === e) this.element.disabled = !1,
