...
<body>
				...
				<ul class="mui-table-view">
					<li class="mui-table-view-cell">
						<a href="${ctx }/wechat/order/myOrders.htm" class="mui-navigate-right notshare"> 
							...
							我的订单 
							<span class="right-text mui-pull-right">查看所有订单</span>
						</a>
					</li>
					...
					<li class="mui-table-view-cell">
						<a href="${ctx }/wechat/user/myWalletPage.htm?userId=${userId}" class="mui-navigate-right notshare"> 
							<span class="mui-icon-extra mui-icon-extra-gold mui-pull-left"></span>我的钱包
						</a>
					</li>
					<li class="mui-table-view-cell no-padding">
					...
					<li class="mui-table-view-cell">
						<a href="${ctx }/wechat/user/jumpMyPoint.htm?userId=${userId}" class="mui-navigate-right notshare"> 
							<span class="mui-icon-extra mui-icon-extra-gold mui-pull-left"></span>我的积分
						</a>
					</li>
					<li class="mui-table-view-cell no-padding">
						<ul id="icon-grid-9" class="icon-grid mui-table-view mui-grid-view mui-grid-9">
							<li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3">
								<a href="${ctx }/wechat/user/jumpMyPoint.htm?userId=${userId}">
									<div class="mui-media-body">昨日收益</div>
								</a> 
								<span class="money-show" id="yesterdayIncome">0.000000</span>
							</li>
							<li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3">
								<a href="${ctx }/wechat/user/jumpMyPoint.htm?userId=${userId}">
									<div class="mui-media-body">累计收益</div>
								</a> 
								<span class="money-show" id="cumulativeIncome">0.000000</span>
							</li>
							<li class="mui-table-view-cell mui-media mui-col-xs-3 mui-col-sm-3">
								<a href="${ctx }/wechat/user/jumpMyPoint.htm?userId=${userId}">
									<div class="mui-media-body">待入积分</div>
								</a> 
					...
					<li style="display: none;" class="mui-table-view-cell">
						<a href="javascript:guideDiv();" class="mui-navigate-right weixinshare"> 
							<span class="mui-icon mui-icon-redo mui-pull-left"></span>
						</a>
					</li>
				</ul>
			</div>
	...
	<script type="text/javascript" charset="utf-8">
		...
		function setUserId() {
			...
			var newUserID = userID.innerHTML.substring(userID.innerHTML.length - 6, userID.innerHTML.length);
