					   ...
					   WeixinJSBridge.invoke(
					       ...
					       function(res){
					    		...
					    		if(res.err_msg == "get_brand_wcpay_request:ok") {
					    			//window.location.href="${ctx }/wechat/test/success/wxpay/${orderId}.htm";
					    			// 检测是否真正支付成功
					        	/*    mui.confirm("支付成功,继续嗨购?", ' ', ['否', '是'], function(e) {
										if (e.index == 1) { */
								...
								/* 			return ;
					       			...
					       			alert("微信支付失败");
					       			window.location.href = "${ctx}/wechat/pay/center/${orderId}.htm";
