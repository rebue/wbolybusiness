...
public class WeChatUserController extends SysController {
    ...
    public void userPoint(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String waitingPoint = OkhttpUtils
                .get(SysContext.ORDERURL + "/ord/detailList/countwaitingbuypoint?userId=" + userId);
    ...
    public void withdrawalApplicationSubmit(HttpServletRequest request, HttpServletResponse response) {
        ...
        String results = HttpUtil.postUrl(SysContext.DAMAIURL + "/withdraw/apply", map);
    ...
    public void applyWithdraw(HttpServletRequest request, HttpServletResponse response,
        ...
        String results = OkhttpUtils.postByJsonParams(SysContext.DAMAIURL + "/withdraw/apply", map);
