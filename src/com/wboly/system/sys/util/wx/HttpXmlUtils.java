...
//			bf.append("<sub_mch_id><![CDATA[");
//			bf.append(unifiedorder.getSub_mch_id());
//			bf.append("]]></sub_mch_id>");
...
//			bf.append("]]></openid>");
	 ...
	 * @return
	 */
	public static String refundXmlInfo(Unifiedorder unifiedorder){
		...
		if(unifiedorder!=null){
			...
			bf.append(unifiedorder.getOp_user_id());
